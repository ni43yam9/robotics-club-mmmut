...
const Card = ({
  ...
  return (
    ...
    >
      <div className="bg-[#050810]/80 p-2 rounded-[25px] shadow-[0px_10px_20px_0px_#000000] border border-blue-900/40">
        ...
        >
          ...
          <h3 className="text-2xl font-semibold text-neutral-100 leading-none mb-[10px]">
            {title}
          </h3>
          <p className="text-neutral-400 text-sm/5 tracking-tight mt-3">
            {description}
          </p>
        </div>
      </div>
...
const DEFAULT_CARD_POSITIONS: StepPosition[] = [
  { className: "md:absolute md:top-0 md:left-[5%]", rotate: "rotate-2" },
  {
    className: "md:absolute md:top-[120px] md:right-[5%]",
    rotate: "-rotate-2",
  },
  { className: "md:absolute md:top-[450px] md:left-[5%]", rotate: "rotate-2" },
  {
    className: "md:absolute md:top-[570px] md:right-[5%]",
    rotate: "-rotate-2",
  },
  { className: "md:absolute md:top-[850px] md:left-[5%]", rotate: "rotate-2" },
];
...
export default function HowItWorks({
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div
        className={`bg-transparent py-10 md:py-20 relative w-full overflow-hidden ${className}`}
      >
        <div
        ...
        <div className="max-w-4xl mx-auto relative z-10 w-full px-4">
          <div
            className="relative w-full max-w-[800px] mx-auto flex flex-col space-y-12 md:space-y-0 md:block h-auto md:h-[var(--md-height)]"
