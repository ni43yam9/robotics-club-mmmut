// Ported from pmndrs/examples "space-game" (src/3d/Rocks.tsx).
// Change: rock model imported from src/assets/game.ts.
...
import { rockUrl } from "../../../assets/game";
...
export default function Rocks() {
  const gltf = useLoader(GLTFLoader, rockUrl) as unknown as GLTFResult;
